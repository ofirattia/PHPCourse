<?php
/** 
	THE FOLLLOWING SCRIPT DESCRIBE USER REGISTRATION, THE ONLY ONE PROBLEM IS THAT IF THE USER FORGET TO 
...
<?php
  //If form submitted, process input.
    ...
    if (empty($name)){
      ...
      onclick="self.location=\'user_register_a.php\'" /></body></html> ');
    }
    if (empty($username)){
